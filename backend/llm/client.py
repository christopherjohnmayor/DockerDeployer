...
class LLMClient:
    ...
    def __init__(self, provider: str = "ollama", api_url: Optional[str] = None, api_key: Optional[str] = None):
        """
        ...
        if provider == "ollama":
            ...
            self.api_url = api_url or os.getenv("LLM_API_URL", "http://localhost:8001/generate")
            self.api_key = api_key or os.getenv("LLM_API_KEY")
        else:
            self.api_url = api_url
            self.api_key = api_key

    async def send_query(self, prompt: str, context: Optional[str] = None, params: Optional[Dict[str, Any]] = None) -> str:
        """
    ...
    async def _send_ollama(self, prompt: str, context: Optional[str], params: Optional[Dict[str, Any]]) -> str:
    ...
    async def _send_litellm(self, prompt: str, context: Optional[str], params: Optional[Dict[str, Any]]) -> str:
        payload = {
            "prompt": prompt,
            "context": context,
            "params": params or {}
    ...
    def set_provider(self, provider: str, api_url: Optional[str] = None, api_key: Optional[str] = None):
        self.provider = provider
