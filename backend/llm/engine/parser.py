...
class DockerCommandParser:
    ...
    def __init__(self):
        ...
        self.valid_operations = {
            "container": ["create", "start", "stop", "restart", "remove", "list", "inspect", "logs", "exec", "stats"],
            ...
            "compose": ["up", "down", "start", "stop", "restart", "logs", "ps", "build"],
    ...
    def validate_docker_command(self, parsed_data: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """
        ...
        if not operation or operation not in self.valid_operations.get(command_type, []):
            return False, f"Invalid operation '{operation}' for command type '{command_type}'"
    ...
    def parse_response(self, response: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not is_valid:
                ...
                if "is_docker_command" in parsed_data and parsed_data["is_docker_command"] is False:
                    return parsed_data
...
class ComposeFileParser:
    ...
    def extract_compose_from_response(self, response: str) -> str:
        ...
        raise ResponseParsingError("Could not extract docker-compose.yml content from LLM response")
    ...
    def parse_response(self, response: str) -> str:
        ...
        try:
            ...
            if not isinstance(e, ResponseParsingError):
                e = ResponseParsingError(f"Failed to parse docker-compose.yml: {str(e)}")
            raise e

def parse_llm_response(response: str, response_type: str = "command") -> Union[Dict[str, Any], str]:
    """
