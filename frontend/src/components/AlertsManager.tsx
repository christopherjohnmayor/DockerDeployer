...
const AlertsManager: React.FC<AlertsManagerProps> = ({ containerId }) => {
  ...
  const { execute: fetchAlerts, loading: alertsLoading, error: alertsError } = useApiCall();
      ...
      <Paper elevation={2} sx={{ p: 3 }}>
        ...
        <TableContainer>
          <Table>
            ...
            <TableBody>
              {alerts
                .filter(alert => !containerId || alert.container_id === containerId)
                .map((alert) => (
                <TableRow key={alert.id}>
                  ...
                  <TableCell>
                    ...
                    >
                      {alert.is_active ? <NotificationsIcon /> : <NotificationsOffIcon />}
                    </IconButton>
                    <IconButton
                      size="small"
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button
            ...
            variant="contained"
            disabled={createLoading || updateLoading || !formData.name || !formData.container_id}
          >
