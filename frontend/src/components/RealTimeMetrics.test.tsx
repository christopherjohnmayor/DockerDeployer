...
describe('RealTimeMetrics', () => {
  ...
  it('fetches stats on mount', async () => {
    ...
    await waitFor(() => {
      expect(mockUseApiCall.execute).toHaveBeenCalledWith('/api/containers/test-container/stats');
    });
  });
  ...
  it('handles API errors gracefully', async () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Error fetching container stats:', expect.any(Error));
